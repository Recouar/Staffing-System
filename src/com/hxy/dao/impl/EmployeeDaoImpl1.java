    ...
    public List<Employee> findAll() {
        ...
        try {
            ...
            while (rs.next()){
                ...
                Employee emp = new Employee( empNo,  ename,  job,  mgr,  new java.sql.Date(hireDate.getTime()),  sal,  comm, deptNo);
                emplist.add(emp);
            }
    ...
    public Employee findById(int empNo) {
        ...
        try {
            ...
            if(rs.next()){
                ...
                double comm = rs.getDouble("comm");
                int deptNo = rs.getInt("deptno");
                emp = new Employee( empNo,  ename,  job,  mgr,  new java.sql.Date(hireDate.getTime()),  sal,  comm, deptNo);
            }
        } catch (SQLException e) {
            e.printStackTrace();
        }finally {
    ...
    public List<Employee> find(int deptno, String job) {
        ...
        try {
            ...
            while (rs.next()){
                ...
                double comm = rs.getDouble("comm");
                int deptNo = rs.getInt("deptno");
                Employee emp = new Employee( empNo,  ename,  job1,  mgr,  new java.sql.Date(hireDate.getTime()),  sal,  comm, deptNo);
                emplist.add(emp);
            }
